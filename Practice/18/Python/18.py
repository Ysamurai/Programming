words = ['hallo', 'klempner', 'das', 'ist', 'fantastisch', 'fluggegecheimen'] #Словарь

def GetCharProb(charID, words_count, vocabulary):
	return vocabulary[charID] / words_count

def Init():
	vocabulary = 256*[0] #Количество определенных букв
	words_count = 0 #Суммарное количество символов
...
x = input()
probability = 1; #Текущая вероятность
